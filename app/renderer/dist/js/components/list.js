...
var List = function (_EventEmitter) {
    ...
    function List(props) {
        ...
        _this.subscribe('search-change', _this.searchChange.bind(_this));
        return _this;
    }

    _createClass(List, [{
        key: 'searchChange',
        value: function searchChange(phrase) {
            ...
            return _react2.default.createElement(
                ...
                this.props.list.map(function (item, index) {
                    return _react2.default.createElement(_item2.default, {
                        itemData: item,
                        isActive: item.id === _this2.props.activeItem,
                        isVisible: item.title.toLowerCase().indexOf(_this2.state.searchValue) > -1,
                        key: item.id });
                })
            );
        }
